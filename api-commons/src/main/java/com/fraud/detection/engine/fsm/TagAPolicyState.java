...
public class TagAPolicyState implements IPolicyState {

    private String nexString;

    public String handler(StateContext<?> context) {

        /**
         * 根据业务逻辑，返回下一个状态的名字
         * Start -> ScriptA -> ScriptB -> TagA -> TagB -> End
         */
        setNextState(PolicyStateName.TAGB);
        return getNextState();

    }

    public String stateName() {
        return PolicyStateName.TAGA;
    }
